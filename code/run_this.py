...
if __name__ == '__main__':
    block_traces = ["datasets/scenario_1/blocks/block-priority-0.csv", "datasets/scenario_1/blocks/block-priority-1.csv","datasets/scenario_1/blocks/block-priority-2.csv"]
    network_trace = "datasets/scenario_1/networks/traces_102.txt"
    
    # The file path of packets' log
    log_packet_file = "output/packet_log/packet-0.log"
    # Select the solution file
    solution_file = 'solution_demos.BBR.solution'
